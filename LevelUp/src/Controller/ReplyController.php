...
class ReplyController extends AbstractController
{
    ...
    /**
     * @Route("/{idr}", name="app_reply_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idr}/edit", name="app_reply_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{idr}", name="app_reply_delete", methods={"POST"})
     */
    public function delete(Request $request, Reply $reply, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$reply->getIdr(), $request->request->get('_token'))) {
