...
{#use Knp\Component\Pager\PaginatorInterface;#}
    ...
    class FactureController extends AbstractController
    {
        ...
        /**
         * @Route("/{idFacture}/pdf", name="app_facture_pdf", methods={"GET","POST"})
         */
        public function pdf(FactureRepository $factureRepository, UserRepository $userRepo, \Swift_Mailer $mailer,Facture $facture)
        {
            ...
            $message = (new \Swift_Message('Nouveau Contact'))
                ->setFrom('tabbenasiwar47@gmail.com')
                ->setTo('tabbenasiwar47@gmail.com')
