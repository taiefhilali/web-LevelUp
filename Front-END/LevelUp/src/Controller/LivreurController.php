...
class LivreurController extends AbstractController
{
    ...
    /**
     * @Route("/{idUser}", name="app_livreur_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idUser}/edit", name="app_livreur_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{idUser}", name="app_livreur_delete", methods={"POST"})
     */
    public function delete(Request $request, Livreur $livreur, LivreurRepository $livreurRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$livreur->getIdUser(), $request->request->get('_token'))) {
